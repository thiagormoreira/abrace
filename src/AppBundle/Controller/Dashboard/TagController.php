...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('dashboard/tag/index.html.twig', array(
            'tags' => $tags,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('dashboard/tag/new.html.twig', array(
            'tag' => $tag,
    ...
    public function showAction(Tag $tag)
    {
        ...
        return $this->render('dashboard/tag/show.html.twig', array(
            'tag' => $tag,
    ...
    public function editAction(Request $request, Tag $tag)
    {
        ...
        return $this->render('dashboard/tag/edit.html.twig', array(
            'tag' => $tag,
